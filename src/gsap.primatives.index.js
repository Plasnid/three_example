...
gsap.to(coneEx.rotation, { duration: 2, x: 3});
gsap.to(coneEx.rotation, { duration: 2, y: 3, delay: 3});
gsap.to(coneEx.rotation, { duration: 2, z: 3, delay: 6});